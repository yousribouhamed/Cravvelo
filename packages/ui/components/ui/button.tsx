...
const buttonVariants = cva(
  "inline-flex items-center justify-center rounded-xl text-sm font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 transform active:scale-95 ",
  {
    variants: {
      variant: {
        default: "bg-[#FC6B00] text-white hover:bg-[#E85D00]",
        destructive: "bg-red-600 text-white hover:bg-red-700",
        outline:
          "border-2 border-[#FC6B00] bg-transparent hover:bg-[#FC6B00] hover:text-white text-[#FC6B00]",
        secondary: "bg-slate-100 text-slate-800 ",
        ghost: " hover:text-[#E85D00] text-slate-700",
        link: "text-[#FC6B00] underline-offset-4 hover:underline hover:text-[#E85D00]",
        primary: "bg-[#FC6B00] text-white hover:bg-[#E85D00]",
