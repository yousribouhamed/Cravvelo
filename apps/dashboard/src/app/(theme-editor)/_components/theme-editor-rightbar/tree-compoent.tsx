...
const TreeCompoent: FC = ({}) => {
  ...
  return (
    <div className="w-full h-[2840px] flex flex-col ">
      ...
      <div className="w-full h-[400px] border-b p-4 ">
      ...
      <div className="w-full h-[50px] border-b p-4">
        <p className="text-md font-semibold text-start">نهاية الموقع</p>
