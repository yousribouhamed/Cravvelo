...
const ThemeHeadingProduction: FC = ({}) => {
  return (
      ...
      <div className="mx-auto max-w-2xl py-6 sm:py-12 lg:py-24">
        ...
        <div className="text-center">
          <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">
            مرحبا بكم في أكاديمية السيف
          </h1>
          <p className="mt-6 text-lg leading-8 text-gray-600">
            هنا يمكنك تعلم كيفية الدفاع عن أعدائك ومهاجمتهم بطريقة فعالة وستحصل
            على كل ما تحتاجه لبدء استخدام السيف
          </p>
...
export default ThemeHeadingProduction;
