...
interface ThemeCollectionType {
  courses: Course[];
}

const ThemeCollectionProduction: FC<ThemeCollectionType> = ({ courses }) => {
          ...
          >
            ...
            <div className="w-full h-[50px] flex items-center justify-between my-4">
              <button onClick={() => handleNavigate({ id: item.id })}>
                <span className="text-black font-semibold text-lg text-start  hover:text-blue-500 ">
                  {item.title}
                </span>
              </button>
