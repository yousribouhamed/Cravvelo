        ...
        <div className="flex w-fir min-w-[100px] justify-end items-center">
          ...
          {isAuthanticated ? (
            ...
            <Link
              ...
              className="bg-primary text-white w-[140px] h-[40px] rounded-xl p-2 flex items-center justify-center hover:bg-blue-700 hover:scale-105 transition-all duration-300"
            >
              تسجيل الدخول
            </Link>
          )}
