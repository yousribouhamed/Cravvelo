...
const VideoChain: FC = ({}) => {
  return (
    <div className="w-full min-h-full h-fit ">
      <div className="w-full min-h-[50px] h-fit bg-gray-100 rounded-xl p-4">
        <Accordion type="single" collapsible>
          <AccordionItem value="item-1">
            ...
            >
              {/* this is the first  */}
              <div className="w-full h-[70px] flex items-center justify-start gap-x-4 cursor-pointer hover:bg-gray-200 transition-all duration-300 ease-in-out">
