    ...
    <div className="w-full min-h-[100px] h-fit pb-4 border-2  border-dashed  border-gray-950 bg-white rounded-lg mx-auto p-2 md:p-8">
      <div className="w-full flex items-center justify-start gap-x-4">
        <div className="w-[20px] h-[20px] rounded-[50%] bg-primary flex items-center justify-center">
          ...
          >
            <path
              d="M10.4609 4.52344V16.8436M16.6209 10.6835H4.30078"
              stroke="white"
              stroke-width="1.23201"
              stroke-linecap="round"
              stroke-linejoin="round"
            />
          </svg>
      ...
      <div className="w-full mt-4 h-[80px] md:h-[50px] overflow-x-auto flex items-center justify-start gap-x-6">
        {maps.map((item) => {
          return (
            ...
            >
              {item.disabled && (
                <span className="block bg-[#2D2D2D] p-1 rounded-2xl text-white text-xs absolute -top-4 left-0">
                  قريبًا
                </span>
              )}
              <div className="w-[30px] relative h-[30px] rounded-[50%] flex items-center justify-center">
                <item.icon />

                <div className="absolute w-[30px]  h-[30px] rounded-[50%] opacity-[15.5%]  bg-primary "></div>
              </div>
