    ...
    <Card className="col-span-3 w-full h-full p-0">
      <CardContent className="p-0  w-full h-full">
        ...
        >
          ...
          <div className="min-w-[300px] w-fit h-full flex flex-col items-end justify-center gap-y-2">
            <div className="w-[300px] flex items-center gap-x-4 justify-end">
              <span className="text-sm"> عدد المستخدمين</span>
              <div className="w-[80px] h-1 bg-[#FFB800] rounded-full" />
            </div>
            <div className="w-[300px] flex items-center gap-x-4 justify-end">
              <span className="text-sm"> عدد المستخدمين  Premuim</span>
