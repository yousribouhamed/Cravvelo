...
export default async function PaymentPendingPage() {
  const t = await getTranslations("payments.pending");
  ...
  return (
    ...
    >
      <div className="flex flex-col items-center gap-6 max-w-md w-full">
        <div
          className="flex items-center justify-center w-16 h-16 sm:w-20 sm:h-20 rounded-full bg-primary/10 text-primary"
          aria-hidden
        >
